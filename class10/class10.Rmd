...
First we need to import (i.e. read) our input data. I downloaded the CSV file from the class website: https://bioboot.github.io/bimm143_W20/class-material/lab-9-bimm143.html
```{r}
...
There are some funkey things in this dataset that we will ignore for our analysis. 
This includes the ID and Diagnosis colums and the funny last x column (col33).
```{r}
...
The 1st PC captures 44.27% of the original variance. Note that 72.67% is captured in the first 3 PCs.
...
This does not look good! Let's try and combine the results 
of PCA with clustering...
