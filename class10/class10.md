class10: Unsupervised Learning Mini-Project
================
Jinyoung Park
2/6/2020
...
analysis. This includes the ID and Diagnosis colums and the funny last x
column (col33).
...
\-The input variables have significantly different variances. -Check the
mean and standard deviation of the features (i.e. columns) of the
wisc.data to determine if the data should be scaled. Use the
...
Looks like we need to set sclae=TRUE\!\!
...
The 1st PC captures 44.27% of the original variance. Note that 72.67% is
...
We can use `table()` function to compare the $diagnosis vector with our
