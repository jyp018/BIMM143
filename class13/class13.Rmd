...
Here we will download the 1HSG PDB structure from the online database, remove the boun drug from Merk and write out a protein only and ligand only new set of PDB files.
