...
A little bit more tidying work required. Lets move the genes where we
...
Now we have our geneIDs in the correct format we can do pathway
analysis.
...
Make a input vector of our numeric quantity of interest (i.e. fold
...
```
    ...
    ## Info: Working in directory /Users/jinyoungpark/Desktop/BIMM143_W20/bimm143_github/class16
